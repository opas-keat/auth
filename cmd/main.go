...
// 	// public static final String IV = "AAACCCDDDYYUURRS";

// 	var plainText = "123456 Test ทดสอบ 001/2565 ๑๒๓๔๕๖ @<>-/*-"

// 	encryptedData := util.AESEncrypt(plainText, []byte(passphrase))
// 	encryptedString := base64.StdEncoding.EncodeToString(encryptedData)
// 	fmt.Println(encryptedString)
// 	encryptedString = "CPlpXAYFIjLgfhebVjUv9emDxXiy7qI39MQ/YHnFWSEaXUZYxriFCRntIVoJA9wMjpRe8QMvLHNTHJ4ooMtf+w=="

// 	encryptedData, _ = base64.StdEncoding.DecodeString(encryptedString)
// 	decryptedText := util.AESDecrypt(encryptedData, []byte(passphrase))
